const GenericErrorImage = () => {
  return (
    <div className="max-w-[70%] lg:max-w-[90%] mx-auto w-full">
      <svg viewBox="0 0 1022.7 785.81">
        <defs>
          <linearGradient
            id="af83dc26-9572-4816-b7a1-1af4f72ff554-563"
            x1="678.2"
            y1="821.79"
            x2="678.2"
            y2="493.4"
        ...
        <title>Ilustração de erro genérico</title>
        <ellipse
          cx="468.63"
          cy="660.88"
          rx="425"
        ...
        <g opacity="0.1">
          ...
          <path
            ...
            opacity="0.1"
          />
          <circle cx="925.49" cy="102.72" r="10.69" className="fill-primary" />
          <circle cx="987.93" cy="109.58" r="10.69" className="fill-primary" />
          <circle cx="1012.01" cy="205.64" r="10.69" className="fill-primary" />
          <circle cx="979.51" cy="253.61" r="10.69" className="fill-primary" />
          <circle cx="935.11" cy="353.24" r="10.69" className="fill-primary" />
          <circle cx="935.11" cy="353.24" r="10.69" opacity="0.1" />
          <circle cx="836.39" cy="240.4" r="10.69" className="fill-primary" />
        ...
        <g opacity="0.1">
          ...
          <path
            ...
            opacity="0.1"
          />
          <circle cx="48.97" cy="324.78" r="5.39" className="fill-primary" />
          <circle cx="17.51" cy="328.24" r="5.39" className="fill-primary" />
          <circle cx="5.39" cy="376.63" r="5.39" className="fill-primary" />
          <circle cx="21.76" cy="400.8" r="5.39" className="fill-primary" />
          <circle cx="44.12" cy="450.99" r="5.39" className="fill-primary" />
          <circle cx="44.12" cy="450.99" r="5.39" opacity="0.1" />
          <circle cx="93.85" cy="394.14" r="5.39" className="fill-primary" />
        ...
        <path
          ...
          transform="translate(-88.65 -57.09)"
          fill="url(#af83dc26-9572-4816-b7a1-1af4f72ff554-563)"
        />
        <path
...
export default GenericErrorImage;
